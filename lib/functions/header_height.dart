/// This file contains functions that return the height of the header based on the number of events in the day.
/// The header height is used to calculate the height of the event column.
double getHeaderHeight(int numEvents) {
  if (numEvents == 0) {
    return 0;
  } else if (numEvents == 1) {
    return 35;
...
double getExpandedHeaderHeight(int numEvents) {
  if (numEvents == 0) {
    return 0;
  } else if (numEvents == 1) {
    return 35;
